...
<CENTER>
<FONT SIZE="+2">
Apache::PageKit Frequently Asked Questions $Id: FAQ.pod,v 1.2 2002/10/26 01:07:30 tjmather Exp $
</FONT>
<BR>
<FONT SIZE="-1">
...
To fix the problem apply this patch from Steve Hay or use I<libapreq-1.3>
  ...
  +++ c/Makefile.PL 2003-08-21 11:31:42.000000000 +0100
  @@ -34,7 +34,8 @@
   sub MY::dynamic {
       my $self = shift;
...
Copyright (c) 2002, 2003 Boris Zentner
